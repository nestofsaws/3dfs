        ...
        <div class="container">
			...
			<div class="col-md-6 d-flex flex-wrap">
			 <div class="col-12"> 
			  ...
			  <h2 class="text-dark"><strong>PROTECTING POWER NETWORKS</strong></h2>
						  ...
						  <div class="carousel slide" data-ride="carousel">
							  <div class="carousel-inner">
								<div class="carousel-item active">
									<h3 class="text-success">Reduces energy consumption</h3>    
								</div>
								<div class="carousel-item">
									<h3 class="text-success">Improves power network stability</h3>    
								</div>
								<div class="carousel-item">
									<h3 class="text-success">Enhances asset performance</h3>    
								</div>
								<div class="carousel-item">
									<h3 class="text-success">Eliminates utility penalties</h3>    
								</div>
							  </div>
							</div>
							<a href="#" class="btn red-3dfs-button mr-3 my-2">Learn More</a>
			 ...
			 <div class="col-12">
			  <h3 class="text-white text-center mt-5">Fast, Easy Installation. Done.</h3>
			  <h4>Non-Invasive Installation,</h4>
			  <h4>Maintenance Free Operation</h4>
			  <p>The <a href="#" class="text-success">VectorQ Series power controller</a> is quickly and non-invasively installed into power networks. It can be done in <strong>20 minutes</strong> without disrupting power and does not require any maintenance.</p>
			  <h4 class="mt-4">Instantly Clean Electricity</h4>
			  <h4>and Secure Power Network</h4>
